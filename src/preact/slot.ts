...
import { Component, createContext, createElement, createRef, ContextType } from 'preact';
...
export class SlotElement extends Component {
  ...
  declare context: ContextType<typeof SlotCtx>;
...
export const getPreactProps = (props: Record<string, any>): Record<string, any> => {
